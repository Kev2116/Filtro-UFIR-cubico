-- -------------------------------------------------------------
-- 
-- File Name: C:\Users\Windows\Documents\Practicas MATLAB\Cubico\cubico\Discrete_FIR_Filter.vhd
...
-- Source Path: cubico/cubico/Discrete FIR Filter
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF Discrete_FIR_Filter IS
  ...
  SIGNAL gain_cast                        : signed(47 DOWNTO 0);  -- sfix48_En38
  ...
  SIGNAL multiplier_mul_temp_32           : signed(47 DOWNTO 0);  -- sfix48_En38
...
BEGIN
  ...
  -- coeff10
  gain_cast <= resize(delay_pipeline_8, 48);
  product10 <= gain_cast(43 DOWNTO 28);
  ...
  coeff11 <= to_signed(-16#000E#, 16);

  multiplier_mul_temp_9 <= delay_pipeline_9 * coeff11;
  product11 <= multiplier_mul_temp_9(43 DOWNTO 28);
  ...
  coeff12 <= to_signed(-16#0017#, 16);

  multiplier_mul_temp_10 <= delay_pipeline_10 * coeff12;
  product12 <= multiplier_mul_temp_10(43 DOWNTO 28);
  ...
  coeff13 <= to_signed(-16#001B#, 16);

  multiplier_mul_temp_11 <= delay_pipeline_11 * coeff13;
  product13 <= multiplier_mul_temp_11(43 DOWNTO 28);
  ...
  coeff14 <= to_signed(-16#001C#, 16);

  multiplier_mul_temp_12 <= delay_pipeline_12 * coeff14;
  product14 <= multiplier_mul_temp_12(43 DOWNTO 28);
  ...
  coeff17 <= to_signed(-16#000D#, 16);

  multiplier_mul_temp_15 <= delay_pipeline_15 * coeff17;
  product17 <= multiplier_mul_temp_15(43 DOWNTO 28);
  ...
  gain_mul_temp <=  - (resize(delay_pipeline_16 & '0' & '0', 48));
  product18 <= gain_mul_temp(43 DOWNTO 28);
  ...
  coeff30 <= to_signed(16#0047#, 16);

  multiplier_mul_temp_27 <= delay_pipeline_28 * coeff30;
  product30 <= multiplier_mul_temp_27(43 DOWNTO 28);
  ...
  coeff31 <= to_signed(16#003B#, 16);

  multiplier_mul_temp_28 <= delay_pipeline_29 * coeff31;
  product31 <= multiplier_mul_temp_28(43 DOWNTO 28);
  ...
  coeff32 <= to_signed(16#002B#, 16);

  multiplier_mul_temp_29 <= delay_pipeline_30 * coeff32;
  product32 <= multiplier_mul_temp_29(43 DOWNTO 28);
  ...
  coeff33 <= to_signed(16#0015#, 16);

  multiplier_mul_temp_30 <= delay_pipeline_31 * coeff33;
  product33 <= multiplier_mul_temp_30(43 DOWNTO 28);
  ...
  coeff34 <= to_signed(-16#0007#, 16);

  multiplier_mul_temp_31 <= delay_pipeline_32 * coeff34;
  product34 <= multiplier_mul_temp_31(43 DOWNTO 28);
  ...
  coeff35 <= to_signed(-16#002A#, 16);

  multiplier_mul_temp_32 <= delay_pipeline_33 * coeff35;
  product35 <= multiplier_mul_temp_32(43 DOWNTO 28);

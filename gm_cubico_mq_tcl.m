...
function tclCmds = gm_cubico_mq_tcl
tclCmds = {
    'do cubico_compile.do',...% Compile the generated code
    'vsimulink   work.cubico',...% Initiate cosimulation
    'add wave  /cubico/clk',...% Add wave commands for chip input signals
    'add wave  /cubico/in1',...
    'add wave  /cubico/out_rsvd',...% Add wave commands for chip output signals
